...
class GetMatplotlibCode(BasePrompt):
    """
    Prompt for getting matplotlib code.
    """
    ...
    Your response must include a python code that uses matplotlib library to make a chart of the data using the dataframe 'df'. \
